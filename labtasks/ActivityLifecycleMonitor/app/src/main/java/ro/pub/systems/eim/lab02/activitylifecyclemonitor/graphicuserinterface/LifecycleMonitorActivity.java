...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onRestart () {
        super.onRestart();
        Log.d(Constants.TAG, "RESTART method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "RESTART method was invoked");
    }

    @Override
    protected void onStart () {
        super.onStart();
        Log.d(Constants.TAG, "START method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "START method was invoked");
    }

    @Override
    protected void onResume () {
        super.onResume();
        Log.d(Constants.TAG, "RESUME method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "RESUME method was invoked");
    }

    @Override
    protected void onPause () {
        super.onPause();
        Log.d(Constants.TAG, "PAUSE method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "PAUSE method was invoked");
    }

    @Override
    protected void onStop () {
        super.onStop();
        Log.d(Constants.TAG, "STOP method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "STOP method was invoked");
    }

    @Override
    protected void onDestroy () {
        super.onDestroy();
        Log.d(Constants.TAG, "DESTROY method was invoked");
        //Log.println(Log.DEBUG, "lifecyclemonitor", "DESTROY method was invoked");
    }
